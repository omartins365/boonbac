...
<a href="javascript:void(0)" class="btn btn-danger btn-lg my-2 btn-block d-block"
    onclick="window.location.assign('{{ route('oauth.init', ['driver'=>'google']) }}');"><i class="fab fa-google"></i> Sign in with
    Google</a>
<a href="javascript:void(0)" class="btn btn-primary btn-lg my-2 btn-block d-block"
